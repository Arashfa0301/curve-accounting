...
from curve.get_html import get_data_from_html
from curve.mail_parsers.non_specific_dates import non_specific_dates
from curve.mail_parsers.specific_dates import specific_dates
from contextlib import closing

from curve.parse_date import parse_date
                ...
                for part in email_message.walk():
                    if part.get_content_type() == TEXT_PLAIN:  # ignore attachments/html
                        ...
                        if byte_code:
                            ...
                            transaction_details = get_details(
                                email_text_content)
                            transaction_details["uid"] = email_id.decode(
                                "utf-8")
